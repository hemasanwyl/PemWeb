...
<body>
    <?php include '../content/v1/header.php'; ?>
    <div class="container">
        <h1>Data Mahasiswa</h1>
        <p class="deskripsi">Silahkan Masukan Data Mahasiswa</p>
        ...
        <form action="#" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nim" name="nim" placeholder="Masukan NIM" required>
            </div>
    ...
    <?php include '../content/v1/footer.php'; ?>
</body>
</html>